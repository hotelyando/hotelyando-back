	...
	public ServiceResponse<Parameter> findByHotelId(User user) {
		...
		try {
			...
			if(parameter != null) {
				...
				serviceResponse = generic.messageReturn(null, PrintVariable.NOT_CONTENT, messageSource.getMessage("parameter.not_content", null, LocaleContextHolder.getLocale()));
			}
	...
	public ServiceResponse<Parameter> findByUuid(String uuid) {
		...
		try {
			...
			if(parameter != null) {
				...
				serviceResponse = generic.messageReturn(null, PrintVariable.NOT_CONTENT, messageSource.getMessage("hotel.not_content", null, LocaleContextHolder.getLocale()));
			}
